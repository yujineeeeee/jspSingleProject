...
<div class="container mt-5">
    ...
    <section>
        <div class="row">
            <div class="col-sm">
                <form action="/blog/visitBoardEdit.do" method="post">
                    <input type="hidden" name="idx" value="${visitBoard.visit_idx}">
                    <div class="row mt-3">
                        <div class="col-sm">
                        ...
                        <div class="col-sm">
                            <input type="text" class="form-control" id="name" name="name"
                                   value="${visitBoard.visit_name}" readonly>
                        </div>
                        <div class="col-sm">
                            <input type="text" class="form-control" id="postdate" name="postdate"
                                   value="${visitBoard.visit_postdate}" readonly>
                        </div>
                        <div class="col-sm">
                            <input type="text" class="form-control" id="visitcount" name="visitcount"
                                   value="${visitBoard.visit_visitcount}" readonly>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-sm">
                            <input type="text" class="form-control" id="title" name="title"
                                   value="${visitBoard.visit_title}">
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-sm">
                            <textarea class="form-control" id="content" name="content"
                                      rows="5">${visitBoard.visit_content}</textarea>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-sm">
